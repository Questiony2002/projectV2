...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "D:/Applications/Git/Git/cmd/git.exe" rev-parse "${ref}^0"
...
execute_process(
  COMMAND "D:/Applications/Git/Git/cmd/git.exe" show-ref "b6e4ff69b8abd509647b531bd5b4e86950204f66"
  WORKING_DIRECTORY "D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "b6e4ff69b8abd509647b531bd5b4e86950204f66")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("b6e4ff69b8abd509647b531bd5b4e86950204f66" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/b6e4ff69b8abd509647b531bd5b4e86950204f66")
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "D:/Applications/Git/Git/cmd/git.exe" fetch --tags --force "origin"
    WORKING_DIRECTORY "D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "D:/Applications/Git/Git/cmd/git.exe" symbolic-ref -q HEAD
    WORKING_DIRECTORY "D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "D:/Applications/Git/Git/cmd/git.exe" for-each-ref "--format='%(upstream:short)'" "${current_branch}"
      WORKING_DIRECTORY "D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src"
...
execute_process(
  COMMAND "D:/Applications/Git/Git/cmd/git.exe" status --porcelain
  WORKING_DIRECTORY "D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "D:/Applications/Git/Git/cmd/git.exe" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "D:/Applications/Git/Git/cmd/git.exe" checkout "${checkout_name}"
    WORKING_DIRECTORY "D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "D:/Applications/Git/Git/cmd/git.exe" rebase "${checkout_name}"
    WORKING_DIRECTORY "D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "D:/Applications/Git/Git/cmd/git.exe" rebase --abort
      WORKING_DIRECTORY "D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "D:/Applications/Git/Git/cmd/git.exe" stash pop --index --quiet
          WORKING_DIRECTORY "D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src'."
    ...
    execute_process(
      COMMAND "D:/Applications/Git/Git/cmd/git.exe" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "D:/Applications/Git/Git/cmd/git.exe" reset --hard --quiet
      WORKING_DIRECTORY "D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src"
    )
    execute_process(
      COMMAND "D:/Applications/Git/Git/cmd/git.exe" stash pop --quiet
      WORKING_DIRECTORY "D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "D:/Applications/Git/Git/cmd/git.exe" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src"
      )
      execute_process(
        COMMAND "D:/Applications/Git/Git/cmd/git.exe" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Users/Wangzeyu/wzyDiplomaProject/projectV2/app/.cxx/Release/466a2e6h/arm64-v8a/_deps/llama-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
